defmodule ProjectR0713225Web.Plugs.Locale do
  import Plug.Conn

  @locales Gettext.known_locales(ProjectR0713225Web.Gettext)
  ...
  def call(conn, _options) do
    case fetch_locale_from(conn) do
      nil ->
        conn
      locale ->
        ProjectR0713225Web.Gettext |> Gettext.put_locale(locale)
